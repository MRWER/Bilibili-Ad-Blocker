...
const AdDetector = {
  ...
  analyze(commentData) {
    ...
    // 画像特征
    if (level !== undefined && level <= 2) score += 20;       // 提高低等级权重
